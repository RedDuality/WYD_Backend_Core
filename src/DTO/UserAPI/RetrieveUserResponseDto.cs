...
public class RetrieveUserResponseDto(User user, List<Tuple<Profile, UserProfile, UserClaims, ProfileDetails>> profiles)
{
    ...
    public List<RetrieveDetailedProfileResponseDto> Profiles { get; set; } =
        [.. profiles.Select(up => new RetrieveDetailedProfileResponseDto(up.Item1, up.Item2, up.Item3, up.Item4))];
}