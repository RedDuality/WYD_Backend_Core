...
public class FCMService
{
    ...
    public FCMService(IConfiguration configuration, DeviceService deviceService, ISseService sseService)
    {
    ...
    private FirebaseMessaging Messagging => _messagingInstance.Value;

    public async Task Send(List<User> users, Dictionary<string, string>? data = null)
    {
        var tokensWithUserIds = DeviceService.GetProfilesDevicesTokens(users);
